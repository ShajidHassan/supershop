				...
				<div class="row">
					<div class="col-md-offset-3 col-md-2 col-md-offset-3">
						<div class="form-group">
							...
							<input  type="submit" class="form-control btn btn-primary" name="submit" value="submit" href="r.php">
							<!--<a class="btn btn-default" href="r.php" role="submit"> Submit</a>-->
						</div>
					</div>
				</div>
			</div>
...
$link= mysqli_connect("localhost","root","","supershop");
	if(isset($_POST['submit'])){
		...
		$query= mysqli_query($link,"INSERT INTO product_purchase(id_product_purchase,product_id,quantity,date,price)
		VALUES('".$id_product_purchase."','".$product_name."','".$quantity."','".$date."','".$price."')");
		if($query){
	...
	$query_result= mysqli_query($link,"SELECT product_purchase.quantity,product_purchase.price,product_purchase.date,product.Name FROM product_purchase,product where product.id=product_purchase.product_id");
?>
